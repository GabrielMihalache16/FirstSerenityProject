...
public class CartPage extends BasePage {
    ...
    @FindBy (css = ".data-table tbody tr:nth-child(3)")
    private WebElementFacade thirdItemInCart;
    ...
    public boolean isThirdItemInCartDisplayed(){
        if(thirdItemInCart.isPresent()){
            return true;
        }
        else return false;
    }
